...
import numpy as np
import yaml
from helpers import _get_image_from_binaryproto, _get_image_list_blob, _get_sim_list_blob, _get_label_blob
...
class MyLayer(caffe.Layer):
    ...
    def _get_next_m_batch(self):
        ...
        blobLabel1 = _get_label_blob(self.m_batch_1)
        blobLabel2 = _get_label_blob(self.m_batch_2)
